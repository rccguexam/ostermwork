...
#vraj@DESKTOP-8NGKNR6:~$ sh 33.sh new.txt
#new.txt exists

#vraj@DESKTOP-8NGKNR6:~$ sh 33.sh new2.txt
...
#vraj@DESKTOP-8NGKNR6:~$ cd mydir/

#vraj@DESKTOP-8NGKNR6:~/mydir$ ls
#new2.txt
