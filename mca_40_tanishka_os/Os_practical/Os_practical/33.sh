...
#tanishka@DESKTOP-8NGKNR6:~$ sh 33.sh new.txt
#new.txt exists

#tanishka@DESKTOP-8NGKNR6:~$ sh 33.sh new2.txt
...
#tanishka@DESKTOP-8NGKNR6:~$ cd mydir/

#tanishka@DESKTOP-8NGKNR6:~/mydir$ ls
#new2.txt
