...
#In a college, students are allowed to select any one elective subject during his studies. Create two files by #entering the data as
...
#Madhu
#Computer graphics
#No one choosen Computer graphics as elective subject
#Parallel Processing
#Mahim
#Data Mining
#Esha
